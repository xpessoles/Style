...
\usepackage{placeins} 	%Pour utiliser la commande \FloatBarrier pour vider la mï¿½moire des figures.
...
\usepackage{longtable} % tableaux évolués
...
\usepackage{caption}
\usepackage{ulem}
\usepackage{xfrac}%pour utiliser sfrac
...
\newcounter{cptexo}
\newcommand{\exo}[1]{{\stepcounter{cptexo}\bf \vspace{0.5cm}{\color{ocre}\begin{Large}Exercice \arabic{cptexo} : \end{Large}} \begin{large}#1\end{large}\vspace{0.5cm}}}
