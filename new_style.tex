...
% ONGLETS (Placé dans le pied de page)
...
{%
    \refstepcounter{numques}%
    \vspace{.15cm}%
    \textbf{\indent Question\,\textcolor{bleuxp}{\thenumques}\,}%
    \textit\bgroup
}
{%
    \egroup
...
\newcommand{\exo}[1]{\stepcounter{cpexo}\vspace{0.25cm} \noindent  \textsf{\textbf{\large Exercice {\color{bleuxp} \arabic{cpexo}}  -- #1}} \vspace{0.25cm}} 
 
 
 \newcounter{cptactivite}
%\newcommand{\activite}[1]{{\stepcounter{cptactivite}\bf \vspace{0.5cm}{\color{ocre}\begin{Large}Activité \arabic{cptactivite} : \end{Large}} \begin{large}#1\end{large}\vspace{0.5cm}}}

\newcommand{\activite}[1]{\stepcounter{cptactivite}\vspace{0.25cm} \noindent  \textsf{\textbf{\large Activité {\color{ocre} \arabic{cptactivite}}  -- #1}} \vspace{0.25cm}}

%\bf {\noindent \color{ocre}\begin{Large}Activité \arabic{cptactivite} : \end{Large}} \begin{large}#1\end{large}}}
